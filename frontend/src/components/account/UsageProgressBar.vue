...
const formatAccountCost = computed(() => {
  if (!props.windowStats) return formatCurrency(0)
  return formatCurrency(props.windowStats.cost)
})

const formatUserCost = computed(() => {
  if (!props.windowStats || props.windowStats.user_cost == null) return formatCurrency(0)
  return formatCurrency(props.windowStats.user_cost)
})
