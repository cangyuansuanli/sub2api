...
// 与后端展示精度一致，统一使用沧耳计费单位。
const formatUsd = (n: number) => formatCurrency(n)
const formatBalance = (b: number) => formatCurrency(b)
const formatCost = (c: number) => formatCurrency(c, 4)
