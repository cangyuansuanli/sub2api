export default {
  ...
  keys: {
    ...
    quotaLimit: '额度限制',
    quotaAmount: '额度金额 (沧耳)',
    quotaAmountPlaceholder: '输入沧耳额度限制',
  ...
  checkIn: {
    title: '每日签到',
    description: '连续签到领取沧耳奖励',
    subtitle: '连续签到',
    streakDays: '天',
    checkedInToday: '今日已签到',
    nextReward: '今日可领',
    progress: '本轮进度',
    progressLabel: '{current} / {total} 天',
    milestoneDay4: '4 天',
    milestoneDay16: '16 天纪念',
    checkInButton: '立即签到',
    checkingIn: '签到中...',
    alreadyCheckedIn: '今日已签到',
    successTitle: '签到成功',
    successAmount: '获得 {amount}',
    milestoneReachedDay4: '达成 4 天额外奖励',
    milestoneReachedDay16: '达成 16 天纪念奖励',
    dailyReward: '每日基础奖励',
    nextMilestone: '下一里程碑',
    dayLabel: '第 {day} 天',
    rulesTitle: '签到规则',
    ruleDaily: '每日签到领取 {amount}',
    ruleDay4: '连续签到 4 天共 {total}',
    ruleDay16: '连续签到 16 天纪念奖励 {total}',
    ruleNonRefundable: '签到赠送余额不可退款',
    recentTitle: '签到日历',
    thisMonth: '本月',
    loadFailed: '加载签到状态失败',
  ...
  admin: {
    ...
    accounts: {
      ...
      quotaLimitHint: '设置日/周/总使用额度（沧耳），任一维度达到限额后账号暂停调度。Anthropic API Key 账号还可配置客户端亲和。修改限额不会重置已用额度。',
    ...
    settings: {
      ...
      payment: {
        ...
        balanceRechargeMultiplierHint: '用户每支付 1 CNY 可获得多少沧耳余额',
        balanceRechargePreview: '预览：1 CNY = {amount} 沧耳',
  ...
  payment: {
    ...
    amountLabel: '充值金额',
    paymentAmount: '支付金额',
    creditedBalance: '到账沧耳',
    quickAmounts: '快捷金额',
    selectProduct: '选择充值商品',
    tierHint: '充值越多，优惠越大',
    tierCreditLabel: '{amount} 沧耳',
    tierDiscount: '省 {percent}%',
    tierStandardRate: '1:1 充值',
    tierSavings: '阶梯优惠',
    tierStockOk: '库存充足',
    customAmount: '自定义沧耳数量',
    customAmountPreview: '到账 {credit} 沧耳，实付 {pay}',
    customAmountPreviewDiscount: '到账 {credit} 沧耳，实付 {pay}（省 {percent}%）',
    enterAmount: '搜索或输入沧耳数量',
    announcementTitle: '店铺公告',
    announcementLines: [
      '本店承诺 1:1 充值，官方价格计费',
      '用量与扣费记录全程可查，透明可控',
      '充值金额越高，享受更多阶梯优惠',
    ...
    rechargeRatePreview: '当前倍率：1 CNY = {amount} 沧耳',
    refundReason: '退款原因',
    ...
    admin: {
      ...
      userBalance: '用户余额',
      orderAmount: '订单金额',
      insufficientBalance: '余额不足，将扣至 0 沧耳',
